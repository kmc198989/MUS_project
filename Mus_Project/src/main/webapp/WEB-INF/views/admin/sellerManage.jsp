		...
		<div class="seller_table_wrap">
			...
			<c:if test="${listCheck != 'empty' }">
				<table class="seller_table">
					<thead>
						<tr>
							<th class="th_column_1">판매자 번호</td>
							<th class="th_column_2">상호 / 대표자</td>
							<th class="th_column_3">브랜드</td>
							<th class="th_column_4">사업자번호</td>
							<th class="th_column_5">통신판매업신고</td>
							<th class="th_column_6">연락처</td>
							<th class="th_column_7">E-mail</td>
							<th class="th_column_8">영업소재지</td>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${list }" var="list">
							<tr>
								...
								<c:out value="${list.brandName }"></c:out></a></td>
