...
<body>
   ...
   <div class="admin_content_wrap">
      <div class="seller_table_wrap">
         ...
         <c:if test="${listCheck != 'empty' }">
            <table class="order_table">
                  <colgroup>
                     ...
                     <thead>
                        <tr>
                           <th class="th_column_1">주문 번호</td>
                           <th class="th_column_2">주문 아이디</td>
                           <th class="th_column_3">주문 날짜</td>
                           <th class="th_column_4">주문 상태</td>
                           <th class="th_column_5">취소</td>
                        </tr>
                     </thead>
                     <tbody>
         ...
         <!-- 게시물 x -->
         <c:if test="${listCheck == 'empty' }">
            <div class="table_empty">주문한 물품이 없습니다.</div>
         </c:if>
      </div>
