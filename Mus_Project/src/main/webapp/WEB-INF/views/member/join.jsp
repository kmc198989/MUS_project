			...
			<div class="wrap">
				...
				<div class="id_wrap">
					...
					<span class="id_input_re_1">사용 가능한 아이디입니다.</span> <span
						...
						class="final_id_ck">아이디를 입력해주세요.</span> <span></span>
				</div>
				...
				<div class="phone_wrap">
					...
					<div class="phone_input_box">
						<input id="phone" class="phone_input" type="text" name="memberPhone"
					...
					<div class="phone_check_wrap">
						<div class="phone_check_input_box">
							<input id="phone2" class="phone_check_input" type="text"
								name="phone2" title="인증번호 입력" disabled required /></br>
						</div>
						...
						<span id="phoneChk2" class="doubleChk"></span> <span
							class="point successPhoneChk"></span> <input type="hidden"
							id="phoneDoubleChk" />
					</div>
					 -->
				</div>
